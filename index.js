...
function kopeginYasi(insanYasi) {
  let kopeginYasiHesaplama = insanYasi*7;
  return kopeginYasiHesaplama;
}
...
function cocukSarkisi(sayi) {
  ...
  return sayi + `${sayi} küçük maymun yatakta zıplamış, biri düşüp başını çarpmış, Anne doktoru aramış, Doktor çok kızmış: Bir daha yatakta zıplamak yok!`
}
for (let i = 5; i >0; i--){
